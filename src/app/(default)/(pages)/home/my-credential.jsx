  ...
  return (
    <>
      ...
      <View className="flex-1">
        <ScrollView refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} />} contentContainerStyle={{ flexGrow: 1, backgroundColor: "#DBEAFE80", paddingHorizontal: 16, gap: 16, paddingTop: 16, paddingBottom: 90 }}>
          {tabs.map((tab, index) => (
            <List.Item
              onPress={() => {
